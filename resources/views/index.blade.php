  ...
  <section class="section-videos">
    <div class="section-videos-container--text">
      ...
      <a class="card-button" href="#">
        ...
        WATCH THE VIDEO</a>
      <p class="paragraph-section">
        There are many YouTube channels and other online video platforms that offer videos about travel and tourist destina
      </p>
    </div>
